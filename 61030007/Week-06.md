...
class Program
{
    static void Main()
    {
        ...
        W คือน้ำหนัก(N)
        m คือมวล(kg)
        g คือแรงดึงดูดของโลก มีค่า = 9.8 m/s^2
        */
