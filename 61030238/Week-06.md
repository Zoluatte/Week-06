...
|   x |   y	  | !x | x && y | x \|\| y | x ^ y |
|-----|-------|----|--------|----------|-------|
true  | true  |false|true   | tru      |ture                |true | false |false| false |true      |false   |
...
![](./imagin/img26.PNG)  
3. เขียนโปรแกรม โดยมีเมธอดที่บอกว่าตัวเลขตั้งแต่ 1 - 100 มี! เลขใดบ้าง ที่บิตที่ 5 มีค่าเป็น 1
![](./imagin/img27.PNG) 
4. เขียนโปร แกรม โดยมีเมธอดคำนวณพื้นที่สี่เหลี่ยมคางหมู โดยรับพารามิเตอร์เป็น ด้านกว้าง ยาว และ ความสูง
![](./imagin/img28.PNG) 
5. เขียนโปรแก![]) รม โดยมีเมธอดคำนวณน้ำหนักของคนบนดวงจันทร์ โดยรับอินพุตเป็นน้ำหนัก มีทศนิยม 1 หลัก
![](./imagin/img29.PNG) 