...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The number is {EvenOdd(number)}");
        }
...
2. เขียนโปรแกรม โดยมีเมธอดที่วนรอบหาตัวเลขที่หารด้วย 7 
ลงตัว โดยเมธอดนั้นรับพารามิเตอร์เป็นค่าตัวเลขเริ่มต้นและสิ้นสุด
...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void findloop7(int b, int l)
        {
            for (int i = b; i <= l; i++)
            {
                if (i % 7 == 0)
...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void trapezide(int b1, int b2, int h)
        {
    ...
    class Program
    {
        ...
        {   /*
            ...
            */
            ...
            Console.WriteLine(" m : Mass");
            Console.WriteLine(" g : Gravity = 9.81 m/s^2");
            Console.WriteLine("------------------------------");
